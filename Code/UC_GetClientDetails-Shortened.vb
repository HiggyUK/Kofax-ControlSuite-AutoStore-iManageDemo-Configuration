...
Module Script
	...
	Sub ClientID_OnChange(ByVal eventData As MFPEventData)
	...
	End Sub
	Sub MatterID_OnChange(ByVal eventData As MFPEventData)
		...
		Dim workspaceText As TextField = eventData.Form.Fields.GetField("WorkSpace")
